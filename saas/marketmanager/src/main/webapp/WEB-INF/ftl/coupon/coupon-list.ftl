            ...
            <div class="card-box">
                <form class="form-inline" role="form" action="${base}/coupon/couponPage.do">
                    <div class="form-group m-l-15">
                        <label>优惠券名称：</label>
                        <input type="text" class="form-control" placeholder="输入优惠券名称" name="activeRuleName" value="${activeRuleName}">
                    </div>
                    <div class="form-group m-l-15">
                        <label>优惠券类型：</label>
                    ...
                    <div class="form-group m-l-15">
                        ...
                        <select id="status" class="form-control" name="activeStatus">
                            <option value="-1" <#if activeStatus?exists && activeStatus == -1>selected</#if>>全部</option>
                            <option value="0" <#if activeStatus?exists && activeStatus == 0>selected</#if>>未过期</option>
                            <option value="1" <#if activeStatus?exists && activeStatus == 1>selected</#if>>已过期</option>
                        </select>
                    </div>
                    <div class="form-group m-l-15">
