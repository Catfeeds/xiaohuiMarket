    ...
    <div class="content">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <#if (markets?size > 0) >
                            ...
                            <tr>
                                ...
                                <td>自营</td>
                                <td>
                                    <div id="statusBtn" data_s="${market.onlineStatus}" data_status="${market.status}" data_id="${market.id?c}" data_v="${market.name}" style="cursor: pointer">
                                        <#if market.status == 0>
                                        ...
                                        <#if market.status == 2>
                                            <span class="label label-danger">关店</span>
                                        </#if>
                                        <#if market.status == 4>
                                            <span class="label label-danger">维护</span>
                                        </#if>
                                        <#if market.onlineStatus == 2>
                                            <span class="label label-danger">与硬件断连</span>
                                        </#if>
                                        <#if market.replenishmentStatus == 2>
                                            <span class="label label-danger">补货中</span>
                                        </#if>
                                    </div>
                                </td>
                                <td>
        ...
        <script type="text/javascript">
            ...
            <#if (markets?size > 0)>
                ...
                //单项状态改变
                _marketListTable.find('div[id=statusBtn]').each(function () {
                    $(this).on('click', function () {
