                        ...
                        <div class="col-md-8">
                            <form class="form-horizontal" role="form" onkeypress="if(event.keyCode==13) {$('#saveBtn').click();return false;}" method="POST" action="${base}/marketmanager/" id="formDefault">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="mDistance" class="form-control" <#if market?exists>
                                               value="${market.coveringDistance?c}" </#if>  onkeyup="clearNoNum(this)">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="mDeliveryCost" class="form-control" <#if market?exists>
                                               value="${market.deliveryCost}" </#if>  onkeyup="clearNoNum(this)">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="mFreeDeliveryCost" class="form-control" <#if market?exists>
                                               value="${market.freeDeliveryFee}" </#if>  onkeyup="clearNoNum(this)">
                                    </div>
                                </div>
