                        ...
                        <#--<select id="houseSelect" class="form-control" name="warehouseName">-->
                            ...
                            <#--<#if warehouseItem?exists >-->
                                <#--<#list warehouseItem as warehouse>-->
                                    <#--<option value="${warehouse.warehouseName}" <#if warehouseName?exists && warehouseName == warehouse.warehouseName>selected</#if>>-->
                                        <#--${warehouse.warehouseName}-->
                                    <#--</option>-->
                                <#--</#list>-->
                            <#--</#if>-->
                        <#--</select>-->
                        <input type="text" class="form-control" placeholder="输入仓库名称" name="warehouseName" value="${warehouseName}">
                    </div>
                    <div class="form-group m-l-15">
                        <label>状态：</label>
                ...
                $("#stopOkBtn").on('click',function () {
                    ...
                    $.post("${base}/purchase/updateWarehouseStatus.do?id=" +$(that).attr("data_id")+ "&status=0&stopRemark=" +txt, function(data) {
                        ...
                        if(data.code == "0") {
                            ...
                            setTimeout(function(){
                                location.href = "${base}/purchase/warehousePage.do?pageIndex=${pageIndex}";
                            },1000);
                        } else {
