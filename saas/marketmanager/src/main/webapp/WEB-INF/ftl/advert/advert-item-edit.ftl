            ...
            <div class="card-box">
                <form class="form-inline" role="form" action="${base}/advert/adverts.do">
                    <div class="form-group m-l-15">
                        <label>广告标题：</label>
                        <input type="text" class="form-control" id="advertNavTitle" placeholder="输入广告标题关键字" name="title" value="${title}">
                    </div>
                    <div class="form-group m-l-15">
                        <label>广告时长：</label>
                        <select id="advertNavTime" class="form-control" name="timeType">
                            <option class="optionTime" value="-1" <#if timeType?exists && timeType == -1>selected</#if>>选择广告时长</option>
                            <option class="optionTime" value="0" <#if timeType?exists && timeType == 0>selected</#if>>15s以内</option>
                            <option class="optionTime" value="1" <#if timeType?exists && timeType == 1>selected</#if>>16s-30s</option>
                            <option class="optionTime" value="2" <#if timeType?exists && timeType == 2>selected</#if>>31s-60s</option>
                            <option class="optionTime" value="3" <#if timeType?exists && timeType == 3>selected</#if>>61s-90s</option>
                            <option class="optionTime" value="4" <#if timeType?exists && timeType == 4>selected</#if>>91s-120s</option>
                            <option class="optionTime" value="5" <#if timeType?exists && timeType == 5>selected</#if>>121s以上</option>
                        </select>
                    </div>
                    <div class="form-group m-l-15">
                ...
                <div class="modalAdvertStyle">
                    <form class="form-horizontal" id="uploadForm" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="modalAdvertTitle" placeholder="输入广告标题" name="title"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">广告时长：</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="modalAdvertTime" placeholder="输入广告时长(单位/秒)" name="timeSize"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">广告备注：</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="modalAdvertRemark" placeholder="输入广告备注" name="remark"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">附&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;件：</label>
                            <div class="col-md-6">
                                <input class="form-control" id="modalAdvertFile" type="file" multiple="multiple" name="file"/>
                            </div>
                        </div>
