            ...
            <div class="row m-t-30">
                <div class="col-md-8">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">满(元)：</label>
                            <div class="col-md-8">
                                <input type="text" id="defaultPrice" class="form-control" <#if item?exists>
                                       value="${item.defaultPrice}" </#if> onkeyup="clearNoNum(this)">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" id="itemInfo" rows="5"><#if item?exists><#if item.description?? >${item.description}</#if></#if></textarea>
                            </div>
                        </div>
