                                    ...
                                    <#if (commoditys?size > 0)>
                                        <#list commoditys as commodity>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" value="${(commodity.costPrices?c)!}" disabled="disabled">
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" value="${(commodity.costPrice?c)!}" onblur="clearInputErr(this);">
                                                </td>
                                                <td>
